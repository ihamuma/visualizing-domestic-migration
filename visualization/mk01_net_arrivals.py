...
mk01_arrivals = mk01_arrivals.groupby(['Year', 'Region of arrival'])[
...
mk01_departures = mk01_departures.groupby(['Year', 'Region of departure'])[
    'Value'].sum().reset_index()
...
mk01_net['Net gain'] = mk01_net.apply(
